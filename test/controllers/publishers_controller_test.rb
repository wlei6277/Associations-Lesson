...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { revenue: @publisher.revenue, title: @publisher.title } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { revenue: @publisher.revenue, title: @publisher.title } }
